  ...
  return (
    <div className="lcm-overlay" onClick={onCancel}>
      <div className="lcm-box" onClick={e => e.stopPropagation()}>
        <img src="/confirmLeaveBg.webp" alt="" className="lcm-bg" draggable={false} />
